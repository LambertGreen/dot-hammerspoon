...
exclusionFilter = hs.window.filter.new({
    ...
    ['Parallels Desktop'] = {activeApplication=true},
    ['Parallels Mac VM'] = {activeApplication=true},
    ['macOS 12 VM'] = {activeApplication=true},
...
inclusionFilter = hs.window.filter.new({
    ...
    ['Parallels Desktop'] = {activeApplication=false},
    ['Parallels Mac VM'] = {activeApplication=false},
    ['macOS 12 VM'] = {activeApplication=false},
